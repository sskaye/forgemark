...
describe("editor round trip: must be byte-identical", () => {
  const cases: Record<string, string> = {
    ...
    alert: "> [!NOTE]\n> Useful information.\n",
    "Obsidian callout": "> [!Takeaway]+\n> Keep it short.\n",
    "Obsidian embeds": "See ![[diagram.png]] and ![[figures/plot.svg|The plot]].\n",
    "Obsidian links": "Read [[Meeting notes]], [[notes/plan|the plan]], and ![[paper.pdf]].\n",
    footnotes: "Claim[^1].\n\n[^1]: The note.\n",
